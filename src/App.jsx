...
// async function - is called when the register form is submitted
  const createMember =  async (user, pwd) => {
    ...
    try {
      ...
      const returnedMember = await fetch('https://ca-t3a2-b-travelers-forum-server-production.up.railway.app/auth/register', {
        method: 'POST',
        headers: {
...
// async function - is called when the login form is submitted
  const loginMember =  async (username, password) => {
    ...
    try {
      ...
      const returnedMember = await fetch('https://ca-t3a2-b-travelers-forum-server-production.up.railway.app/auth/login', {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json'
...
// async function - is called when the create a post form is submitted
  const submitPost =  async (title, continent, postContent) => {
    ...
    try {
      ...
      const returnedPost = await fetch('https://ca-t3a2-b-travelers-forum-server-production.up.railway.app/posts/new', {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
...
const editPost =  async (post, title, continent, postContent) => {
  ...
  try {
    ...
    const returnedPost = await fetch(`https://ca-t3a2-b-travelers-forum-server-production.up.railway.app/posts/${post[0]._id}`, {
      method: 'PUT',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const ratePost =  async (post, rating) => {
  ...
  try {
    ...
    const returnedPost = await fetch(`https://ca-t3a2-b-travelers-forum-server-production.up.railway.app/posts/${post[0]._id}/rating`, {
      method: 'PATCH',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
// async function - is called when the comment form is submitted
  const submitComment =  async (post, comment) => {
    ...
    try {
      ...
      const returnedComment = await fetch('https://ca-t3a2-b-travelers-forum-server-production.up.railway.app/comments/new', {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
...
const deleteComment =  async (comment, post) => {
  ...
  try {
    ...
    const returnComment = await fetch(`https://ca-t3a2-b-travelers-forum-server-production.up.railway.app/comments/${comment.id}`, {
      method: 'DELETE',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const editComment =  async (comment, editedComment, post) => {
  ...
  try {
    ...
    // PUT the new editPost object to the API and assign the return object to returnedPost
    const returnedEditedComment = await fetch(`https://ca-t3a2-b-travelers-forum-server-production.up.railway.app/comments/${comment.id}`, {
      method: 'PUT',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
