...
const FullPagePost = ({ forumMember, post, submitComment, loggedInMember, editPost, deletePost, deleteComment, editComment, ratePost }) => {
    ...
    <>
      <div className="container min-vh-100" style={{ marginTop: "100px"}}>
        {loggedInMember.id == post[0].author._id
          ...
          : <PostContent post={post} forumMember={forumMember} loggedInMember={loggedInMember} ratePost={ratePost} />
        }
